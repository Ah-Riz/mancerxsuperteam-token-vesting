                ...
                <div key={stream.id} className={`${CARD} space-y-4 p-5`}>
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex gap-1.5">
                      <button type="button" onClick={() => duplicateStream(i)} className="rounded-md border border-white/[0.08] px-2 py-1 text-[10px] text-[#8b92a5] hover:text-white" title="Duplicate">
                        Duplicate
                      </button>
                      {streams.length > 1 && (
        ...
        <FormSummary
          ...
          submitLabel={
            mode === "bulk"
              ...
              : `Create ${streams.length} Cliff Stream${streams.length > 1 ? "s" : ""}`
          }
